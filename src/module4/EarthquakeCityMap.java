...
public class EarthquakeCityMap extends PApplet {
	...
	public void setup() {		
		...
		Marker em=new OceanQuakeMarker(f);
	...
	private void printQuakes() 
	{
		...
		for(Marker country:countryMarkers)
		{
			...
			if(landQuakes!=0)
				System.out.println(country.getProperty("name")+" : "+landQuakes);
		...
		System.out.println("Ocean Quakes: "+oceanQuakes);	  // OceanQuakes		
	}
